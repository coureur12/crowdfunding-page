...
//When you click on the button to open the menu it dispear and display the delete button. I think might be another way more efficient to do it.
...
function Header(){
    ...
    return(
        <header className={classes.navbar}>
            ...
            <input className={classes.menu} type="checkbox" Checked={checked} onClick={handleChange} />
            </div>
            ...
            {checked && <NavlistMobile onConfirm={handleChange} />}
            {checked && <Backdrop onConfirm={handleChange} />}
        </header>        
    );
}
